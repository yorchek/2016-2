...
public class Reinas {
    ...
    private static int poblacionIni = 75;           // TamaÃ±o de la poblacion 
    ...
    private static void Fitness() {
        ...
        // La peor puntuaciÃ³n serÃ­a el que tiene la mayor energÃ­a, mejor mÃ¡s bajo.
    ...
    private static void GenerarPoblacionInicial() {
        ...
        for (int i = 0; i < poblacionIni; i++) {
            ...
            // Escoja al azar el nÃºmero de baraja realizar.
